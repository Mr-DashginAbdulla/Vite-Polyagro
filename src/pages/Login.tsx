...
const LoginPage: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://public.readdy.ai/ai/img_res/a5b9a49c768365ea163f7929b5d3aa13.jpg')",
      }}
    >
      <div className="min-h-screen flex items-center justify-center p-4">
        ...
        >
          <div className="flex justify-end space-x-4 mb-4">
            ...
            <button
              onClick={toggleTheme}
              className="text-sm rounded-full hover:opacity-80 cursor-pointer" 
            >
              {theme === "dark" ? (
          ...
          <div className="text-center mb-8">
            <h1 className="font-[pacifico] text-3xl text-[#22c55e]">
              {t("appName")}
            </h1>
          </div>
          ...
          <div className="flex justify-center mb-8">
            <div
              className={`inline-flex rounded-full ${
                theme === "dark" ? "bg-gray-700" : "bg-[#f1f5f9]"
              } p-1`}
            >
              <button
          ...
          {error && (
            ...
            >
              <i
                className={`ri-error-warning-line text-lg mr-2 ${
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    } rounded-lg text-sm focus:ring-2 focus:ring-[#22c55e] focus:border-transparent`}
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-2 border ${
                    theme === "dark"
                      ? "bg-gray-700 border-gray-600 text-white placeholder-gray-400"
                      : "bg-[#f8fafc] border-gray-200 text-gray-900"
                  } rounded-lg text-sm focus:ring-2 focus:ring-[#22c55e] focus:border-transparent cursor-text`}
            ...
            {isLogin && (
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-sm font-medium text-[#22c55e] hover:text-[#22c55e]/80 cursor-pointer"
                >
                  {t("forgotPassword")}
                </a>
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#22c55e] text-white py-2 rounded-lg hover:bg-[#22c55e]/90 transition-colors disabled:opacity-50 cursor-pointer transition-all active:scale-95"
            >
            ...
            <button
              type="button"
              className={`w-full flex items-center justify-center px-4 py-2 transition-all active:scale-95 border ${
                theme === "dark"
